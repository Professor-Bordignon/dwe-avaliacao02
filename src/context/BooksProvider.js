...
const BooksProvider = (props) => {
  ...
  const incluirLivro = (event) => {
    ...
    // Como você inclui um novo objeto dentro de um vetor em Javascript?
    setLivros(livrosAux);
    navigate('/');
  }
  ...
  const alterarLivro = (event) => {
    ...
    const livrosAux = [...livros];
    // Existe um problema no trecho abaixo. 
  ...
  return (
    // Problema: Alguma função importante não está sendo exportada nas linhas abaixo. 
